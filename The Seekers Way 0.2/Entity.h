...
public:
	enum EntityKind {
		SHEEKA, FENRIR, CHARLOTTE, KIBA,
		NORMALBLOCK, BUTTON, DOOR, STONE,
		SHOTTINGTRAP, WOODENWALL, VINE, SPIKETRAP,
		ARROW, SHIELD, PORTAL, LEVER,
		FIREBALL, FIRERUNE, DARKBINDING, MAGICSWITCH};
